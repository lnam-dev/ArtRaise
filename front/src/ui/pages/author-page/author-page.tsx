...
const AuthorPage: React.FC<TAuthorPage> = ({author,authorArtpieces,familiarAuthors}) => {
    ...
    return (
        <div className={"h-fit font-fixel px-4"}>
            ...
            {/*mobile*/}
            <MobileSectionAuthorPage author={author} authorArtpieces={authorArtpieces}/>
            {/*desktop*/}
            ...
            <FamiliarAuthors familiarAuthors={familiarAuthors} className={"columns-1 gap-6 sm:columns-2 lg:columns-3 xl:columns-4 space-y-12 mt-10"}/>
            <CallToActionSection/>
        </div>
    );
};
