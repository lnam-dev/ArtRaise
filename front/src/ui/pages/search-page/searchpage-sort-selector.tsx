    ...
    return (
        <Select onValueChange={handleValueChange}>
            ...
            <SelectContent className="w-full bg-white shadow-[0px_0px_4px_rgb(0,0,0,0.1)] outline px-0">
                <SelectItem className={"transition-all hover:bg-gray-100"} value="newerFirst">Спочатку новіші</SelectItem>
                <SelectItem className={"transition-all hover:bg-gray-100"} value="expensiveFirst">Спочатку дорожчі</SelectItem>
                <SelectItem className={"transition-all hover:bg-gray-100"} value="cheaperFirst">Спочатку дешевші</SelectItem>
                <SelectItem className={"transition-all hover:bg-gray-100"} value="alphabet">А-Я</SelectItem>
                <SelectItem className={"transition-all hover:bg-gray-100"} value="alphabetReverse">Я-А</SelectItem>
                <SelectItem className={"transition-all hover:bg-gray-100"} value="byAuthor">За автором</SelectItem>
            </SelectContent>
        </Select>
    );
};
