...
import {
	buildStoreFrontConfiguration,
	getStoreFront,
} from "~/use-cases/storefront.server";
...
async function getData() {
	...
	const apiPath = buildLanguageMarketAwareLink(
		"/api",
...
export default async ({ children }: { children: React.ReactNode }) => {
	const { frontConfiguration, translations, baseUrl, navigation, footer } =
		await getData();
	const path = "/en";
