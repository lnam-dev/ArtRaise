...
import {setAuthors, setAvailableLetters} from "~/store/client/slices/AuthorsPageSlice";
                        ...
                        return (
                            <div key={letter}>
                                ...
                                <div className="columns-1 gap-6 sm:columns-2 lg:columns-3 xl:columns-4 space-y-12 py-4">
                                    {authorsPageState.mapLetterAuthor[letter].map((artist, index) => <AuthorCard
                                        author={artist} key={index}/>)}
                                </div>
                            </div>
                        )
                    }
