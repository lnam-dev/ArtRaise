...
- `GET /api/faq/how-to-buy/` — Отримати інструкції "Як купити"

#### FAQ: Як купити
**`GET /api/faq/how-to-buy/`**

Повертає список блоків з інструкціями для покупки творів мистецтва. Підтримує локалізацію.

**Параметри запиту:**
- `lang` (опціонально) — Мова відповіді (`en` для англійської, `uk` для української за замовчуванням)

**Приклади запитів:**
```
GET /api/faq/how-to-buy/                  # Українська мова
GET /api/faq/how-to-buy/?lang=en         # Англійська мова
```
...
[
  {
    "id": 1,
    "title": "Крок 1: Огляд каталогу",
    "description": "Перегляньте наш широкий каталог унікальних творів мистецтва...",
    "order": 1,
  ...
  {
    "id": 2,
    "title": "Крок 2: Вибір твору",
    "description": "Оберіть твір, який вам сподобався...",
    "order": 2,
    "created_at": "2025-09-04T12:00:00Z",
    "updated_at": "2025-09-04T12:00:00Z"
  }
...
**Поля відповіді:**
- `id` — Унікальний ідентифікатор блоку
- `title` — Заголовок кроку (локалізований)
- `description` — Опис кроку (локалізований)
- `order` — Порядок відображення
- `created_at` — Дата створення
- `updated_at` — Дата останнього оновлення

**Локалізація:**
API автоматично визначає мову за пріоритетом:
1. Параметр `?lang=en`
2. Заголовок `Accept-Language: en`
3. Заголовок `Content-Language: en`
4. Українська за замовчуванням

**Управління контентом:**
Блоки можна редагувати через CMS: `/cms` → FAQ → "Як купити"
